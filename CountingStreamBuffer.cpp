...
namespace GA
{
	...
	unsigned int CountingStreamBuffer::lineNumber() const  { return lineNumber_; }

	// Get line number of previously read character
	unsigned int CountingStreamBuffer::prevLineNumber() const { return lastLineNumber_; }

	// Get current column
	unsigned int CountingStreamBuffer::column() const   { return column_; }

	// Get file position
	std::streamsize CountingStreamBuffer::filepos() const { return filePos_; }
	...
	std::ios::pos_type CountingStreamBuffer::seekoff( std::ios::off_type pos, std::ios_base::seekdir dir,
	...
	std::ios::pos_type CountingStreamBuffer::seekpos( std::ios::pos_type pos, std::ios_base::openmode mode )
	{
